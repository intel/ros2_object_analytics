...
void TrackingManager::matchTrackDetWithDistance(
  cv::Mat & distance,
  cv::Mat & row_match,
  cv::Mat & col_match)
{
...
void TrackingManager::matchTrackDetWithProb(
  cv::Mat & weights,
  cv::Mat & matches)
{
...
void TrackingManager::matchTrackDetHungarian(
  cv::Mat & weights,
  cv::Mat & row_match,
  cv::Mat & col_match)
{
