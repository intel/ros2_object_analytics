...
void Segmenter::segment(const object_analytics_msgs::msg::TrackedObjects::ConstSharedPtr& objs_2d, const sensor_msgs::msg::PointCloud2::ConstSharedPtr& points, ObjectsInBoxes3D::SharedPtr& msg)
{
...
void Segmenter::doSegment(const object_analytics_msgs::msg::TrackedObjects::ConstSharedPtr& objs_2d, const PointCloudT::ConstPtr& cloud, RelationVector& relations)
{
...
void Segmenter::composeResult(const RelationVector& relations, ObjectsInBoxes3D::SharedPtr& msgs)
{
