...
// void            getRoiPointCloud(const PointCloudT::ConstPtr& cloud, const pcl::PointCloud<PointXYZPixel>::Ptr& pixel_pcl, PointCloudT::Ptr& roi_cloud, const Object2DRoi& obj2d_roi);
void Segmenter::getRoiPointCloud(const PointCloudT::ConstPtr& cloud, const pcl::PointCloud<PointXYZPixel>::Ptr& pixel_pcl, PointCloudT::Ptr& roi_cloud, const Object2D& obj2d)
{
  ...
  unsigned int x = obj2d_roi.x_offset;
  unsigned int y = obj2d_roi.y_offset;
  unsigned int x_ed = x + obj2d_roi.width;
  unsigned int y_ed = y + obj2d_roi.height;
  for (unsigned int i=0; i<pixel_pcl->points.size()-1; i++)
  {
