...
#ifndef OBJECT_ANALYTICS_NODE_TRACKER_TRACKING_MANAGER_H
#define OBJECT_ANALYTICS_NODE_TRACKER_TRACKING_MANAGER_H
...
public:
   ...
   */
  TrackingManager(const rclcpp::Node* node);
...
#endif  // OBJECT_ANALYTICS_NODE_TRACKER_TRACKING_MANAGER_H
